...
namespace ElectromagneticProblem
{
   class Program
   {
      ...
      {
         Area linearArea = Area.FromFile(@"C:\repos\NumericalMethods\Electromagnetic Problem\ElectromagneticProblem\input\linGrid.txt");
         Area nonlinearArea = Area.FromFile(@"C:\repos\NumericalMethods\Electromagnetic Problem\ElectromagneticProblem\input\nonlinGrid.txt");

         if (linearArea != null && nonlinearArea != null)
         {
            CubicHermiteSpline spline = CubicHermiteSpline.FromFile(@"C:\repos\NumericalMethods\Electromagnetic Problem\ElectromagneticProblem\input\mu.txt");
